...
class _UserDataSource implements UserDataSource {
  ...
  @override
  Future<BaseResponse<List<MyNotificationResponse>>>
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<BaseResponse<List<MyNotificationResponse>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value =
        BaseResponse<List<MyNotificationResponse>>.fromJson(_result.data!);
    return value;
  }

  @override
  Future<BaseResponse<GetBankInfoResponse>> getBankInfo() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<BaseResponse<GetBankInfoResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = BaseResponse<GetBankInfoResponse>.fromJson(_result.data!);
    return value;
  }

  @override
  Future<BaseResponse<dynamic>> updateBankInfo(
      UpdateBankInfoRequest updateBankInfoRequest) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(updateBankInfoRequest.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
