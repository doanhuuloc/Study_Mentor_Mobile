...
class UserInfoResponseMapper extends ClassMapperBase<UserInfoResponse> {
  ...
  static DateTime? _$dateOfBirth(UserInfoResponse v) => v.dateOfBirth;
  static const Field<UserInfoResponse, DateTime> _f$dateOfBirth =
      Field('dateOfBirth', _$dateOfBirth, opt: true);
  static String? _$avatar(UserInfoResponse v) => v.avatar;
  static const Field<UserInfoResponse, String> _f$avatar =
