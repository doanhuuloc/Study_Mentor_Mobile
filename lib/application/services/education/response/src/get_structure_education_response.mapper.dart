...
class GetStructureEducationResponseMapper
    extends ClassMapperBase<GetStructureEducationResponse> {
  GetStructureEducationResponseMapper._();

  static GetStructureEducationResponseMapper? _instance;
  static GetStructureEducationResponseMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals
          .use(_instance = GetStructureEducationResponseMapper._());
  ...
  @override
  final String id = 'GetStructureEducationResponse';

  static List<LevelResponse>? _$structure(GetStructureEducationResponse v) =>
      v.structure;
  static const Field<GetStructureEducationResponse, List<LevelResponse>>
      _f$structure = Field('structure', _$structure, opt: true);

  @override
  final MappableFields<GetStructureEducationResponse> fields = const {
    #structure: _f$structure,
  };

  static GetStructureEducationResponse _instantiate(DecodingData data) {
    return GetStructureEducationResponse(structure: data.dec(_f$structure));
  }

  @override
  final Function instantiate = _instantiate;

  static GetStructureEducationResponse fromJson(Map<String, dynamic> map) {
    return ensureInitialized().decodeMap<GetStructureEducationResponse>(map);
  }

  static GetStructureEducationResponse fromJsonString(String json) {
    return ensureInitialized().decodeJson<GetStructureEducationResponse>(json);
  }
}

mixin GetStructureEducationResponseMappable {
  String toJsonString() {
    return GetStructureEducationResponseMapper.ensureInitialized()
        .encodeJson<GetStructureEducationResponse>(
            this as GetStructureEducationResponse);
  }

  Map<String, dynamic> toJson() {
    return GetStructureEducationResponseMapper.ensureInitialized()
        .encodeMap<GetStructureEducationResponse>(
            this as GetStructureEducationResponse);
  }

  GetStructureEducationResponseCopyWith<GetStructureEducationResponse,
          GetStructureEducationResponse, GetStructureEducationResponse>
      get copyWith => _GetStructureEducationResponseCopyWithImpl(
          this as GetStructureEducationResponse, $identity, $identity);
  @override
  String toString() {
    return GetStructureEducationResponseMapper.ensureInitialized()
        .stringifyValue(this as GetStructureEducationResponse);
  }

  @override
  bool operator ==(Object other) {
    return GetStructureEducationResponseMapper.ensureInitialized()
        .equalsValue(this as GetStructureEducationResponse, other);
  }

  @override
  int get hashCode {
    return GetStructureEducationResponseMapper.ensureInitialized()
        .hashValue(this as GetStructureEducationResponse);
  }
}

extension GetStructureEducationResponseValueCopy<$R, $Out>
    on ObjectCopyWith<$R, GetStructureEducationResponse, $Out> {
  GetStructureEducationResponseCopyWith<$R, GetStructureEducationResponse, $Out>
      get $asGetStructureEducationResponse => $base.as(
          (v, t, t2) => _GetStructureEducationResponseCopyWithImpl(v, t, t2));
}

abstract class GetStructureEducationResponseCopyWith<
    $R,
    $In extends GetStructureEducationResponse,
    $Out> implements ClassCopyWith<$R, $In, $Out> {
  ListCopyWith<$R, LevelResponse,
      LevelResponseCopyWith<$R, LevelResponse, LevelResponse>>? get structure;
  $R call({List<LevelResponse>? structure});
  GetStructureEducationResponseCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(
      Then<$Out2, $R2> t);
}

class _GetStructureEducationResponseCopyWithImpl<$R, $Out>
    extends ClassCopyWithBase<$R, GetStructureEducationResponse, $Out>
    implements
        GetStructureEducationResponseCopyWith<$R, GetStructureEducationResponse,
            $Out> {
  _GetStructureEducationResponseCopyWithImpl(
      super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<GetStructureEducationResponse> $mapper =
      GetStructureEducationResponseMapper.ensureInitialized();
  @override
  ListCopyWith<$R, LevelResponse,
          LevelResponseCopyWith<$R, LevelResponse, LevelResponse>>?
      get structure => $value.structure != null
          ? ListCopyWith($value.structure!, (v, t) => v.copyWith.$chain(t),
              (v) => call(structure: v))
          : null;
  @override
  $R call({Object? structure = $none}) => $apply(
      FieldCopyWithData({if (structure != $none) #structure: structure}));
  @override
  GetStructureEducationResponse $make(CopyWithData data) =>
      GetStructureEducationResponse(
          structure: data.get(#structure, or: $value.structure));

  @override
  GetStructureEducationResponseCopyWith<$R2, GetStructureEducationResponse,
      $Out2> $chain<$R2, $Out2>(
          Then<$Out2, $R2> t) =>
      _GetStructureEducationResponseCopyWithImpl($value, $cast, t);
}
